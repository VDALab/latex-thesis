...
\vspace{0.42cm}
%
\large{\univCname}\;\;\large{\deptCname}\;\;\large{博士班}\\ %校名系所名
\vspace{0.83cm}
%\vfill
...
\end{center}
\vspace{2cm}
\input{Thesis_Acknowledgement.tex}
