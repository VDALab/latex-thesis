...
% 論文題目 (中文)
\renewcommand\cTitle{中文標題}

% 論文題目 (英文)
\renewcommand\eTitle{Title in English}

% 我的姓名 (中文)
\renewcommand\myCname{作者姓名}

% 我的姓名 (英文)
\renewcommand\myEname{Author's Namen}

% 指導教授A的姓名 (中文)
\renewcommand\advisorCnameA{教授姓名}

% 指導教授A的姓名 (英文)
\renewcommand\advisorEnameA{Supervisor's Name}
...
% 系所名 (中文)
\renewcommand\deptCname{電子工程學系\;電子研究所}
